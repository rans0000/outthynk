    ...
    return (
        <header className='relative bg-[url(/images/hero-xl.png)] h-svh max-h-[640px] flex flex-col items-center justify-center rounded-b-xl lg:rounded-b-4xl'>
            <div className="fixed z-30 top-0 left-0 px-5 w-full flex justify-center">
                <div className={`relative max-w-[1200px] w-full h-24 px-5 flex justify-center items-center bg-[#0c1018] rounded-b-2xl transition-all duration-500 transform-gpu ${scrollDirection == 1 ? '-translate-y-full opacity-0' : 'translate-y-0 opacity-100'}`}>
                    ...
                    <div className="md:hidden ml-auto">
                        <DropdownMenu>
                            <DropdownMenuTrigger className="!p-1 !rounded-md">
                                <AlignJustifyIcon size={32} className="text-white" />
                            </DropdownMenuTrigger>
            ...
            <h1 className='app-title mb-4 px-5'>Web Design & App Development Studio</h1>
            <p className='px-5 text-white text-base max-w-lg text-center'>We specialize in designing and developing high-performance websites, mobile apps, and software solutions that generate leads, convert customers, and scale your business.</p>
        </header>
    )
}
